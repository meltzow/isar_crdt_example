...
import 'package:isar_crdt_example/models/models.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _incrementCounter() async {
    final cnt = _counter + 1;
    final car = CarModel.fabric(cnt.toString())..sid = "sid_$cnt";
